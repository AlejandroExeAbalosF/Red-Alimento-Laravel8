...
@section('title', 'Editar Nodo Distribuidor')
@section('content_header')
    <h1>Editar Nodo Distribuidor</h1>
@stop
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            {!! Form::model($nodoDistribuidor,['route' => ['panel.nodo_distribuidor.update',$nodoDistribuidor], 'method'=>'put']) !!}
